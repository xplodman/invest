                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div>
                                        <h3 class="card-title m-b-5"><span class="lstick"></span>إحصائية لدفتر حصر التحقيق لسنة <?php echo date('Y') ?> مصنفه بأسباب البقاء (أعلى 10 أسباب)</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="">
                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex">
                                    <div>
                                        <h3 class="card-title m-b-5"><span class="lstick"></span>إحصائية لدفتر حصر التحقيق لسنة <?php echo date('Y') ?> مصنفه بالتهم (أعلى 10 تهم)</h3>
                                    </div>
                                </div>
                            </div>
                            <div class="">
