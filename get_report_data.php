...
WHERE 
  1+1";
    ...
    $prosecutor_name.="GROUP BY prosecutor.name";
...
WHERE
  ...
  case_has_investigation.case_status_idcase_status = 2";
    ...
    $undone_Count_investigation .="GROUP BY prosecutor.name, case_has_investigation.prosecutor_id";
...
WHERE
  ...
  case_has_investigation.case_status_idcase_status = 1";
    ...
    $done_Count_investigation .="GROUP BY prosecutor.name, case_has_investigation.prosecutor_id";
        ...
        while($prosecutor_name_info = mysqli_fetch_assoc($prosecutor_name)) {
            ...
            ?>">
                ...
                <td>
                    ...
                    echo number_format((float)$percentChange, 2, '.', '').'%';
                    ?>
                </td>
            </tr>
            <?php
