...
<?php
$pageTitle = 'إعدادات أسباب البقاء';
        ...
        <div class="container-fluid">
            ...
            <div class="row page-titles">
                <div class="col-md-10 align-self-center">
                    <h3 class="text-themecolor">الإعدادات / أسباب البقاء</h3>
                </div>
                <div class="">
                    <button class="btn btn-success " type="button" data-toggle="modal" data-target="#add_reason_to_done"> إضافة سبب للبقاء </button>
                </div>
            </div>
            <!-- ============================================================== -->
            <?php
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="datatable" class="display table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                    <?php
                                    $result = mysqli_query($con, $reason_to_done_query);
                                    while($reason_to_done_info = mysqli_fetch_assoc($result)) {
                                        ?>
                                        <tr data-child-value="<?php
                                        ?>">
                                            <td>
                                                <?php echo $reason_to_done_info['id_reason_to_done']?>
                                            </td>
                                            <td>
