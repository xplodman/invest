                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group has-danger">
                                            <label FOR="reason_to_done" class="control-label">أسباب البقاء</label>
...
SELECT
  reason_to_done.name,
  reason_to_done.id_reason_to_done AS id
FROM
...
GROUP BY
  ...
  reason_to_done.id_reason_to_done";
                                                ...
                                                foreach ($results as $reason_to_done) {
                                                    ?>
                                                    <option value="<?php echo $reason_to_done["id"]; ?>"
                                                    ><?php echo $reason_to_done["name"]; ?></option>
                                                    <?php
                                                }
                                                ?>
                                            </select>
                                        ...
                                        <label for="all_reason_to_done">إختيار كل الأسباب</label>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group has-danger">
...
<script>
    $(".filters").change(function () {
        ...
        $.ajax({
            type: "POST",
            url: "php/get_reason_to_done_report_data.php",
            data: form_data,
