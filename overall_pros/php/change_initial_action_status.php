...
$initial_action_id=mysqli_real_escape_string($con, $_GET['initial_action_id']);
$status=mysqli_real_escape_string($con, $_GET['status']);

$update_initial_action= mysqli_query($con, "UPDATE `initial_action` SET `status` = '$status', `admin_id` = '$user_id' WHERE `initial_action`.`initial_action_id` = '$initial_action_id';");

if ($update_initial_action) {
    mysqli_commit($con);
