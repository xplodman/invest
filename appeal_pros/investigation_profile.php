...
SELECT
  ...
  case_has_investigation.plaintiff,
  case_has_investigation.defendant,
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group has-danger">
                                                ...
                                                <input  type="text" name="plaintiff" id="plaintiff" class="form-control" placeholder="شكوى /" value="<?php echo $investigation_info['plaintiff']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group has-danger">
                                                <label class="control-label">ضد /</label>
                                                <input  type="text" name="defendant" id="defendant" class="form-control" placeholder="ضد /" value="<?php echo $investigation_info['defendant']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
  ...
  initial_action.deleted = 0";
                                                    ...
                                                    foreach ($results as $initial_action){
                                                        ...
                                                        <option value="<?php echo $initial_action["initial_action_id"];?>"
                                                            <?php
                                                            if (!empty($initial_action)) {
                                                                if((int)$investigation_info['initial_action_id'] == (int)$initial_action['initial_action_id']){
                                                                    echo 'selected';
                                                                }
                                                            }
                                                            ?>
...
WHERE
  ...
  final_action.deleted = 0";
                                                    ...
                                                    foreach ($results as $final_action){
                                                        ...
                                                        <option value="<?php echo $final_action["final_action_id"];?>"
                                                            ...
                                                            if (!empty($final_action)) {
                                                                if((int)$investigation_info['final_action_id'] == (int)$final_action['final_action_id']){
                                                                    echo 'selected';
                                                                }
                                                            }
                                                            ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group has-danger">
                                                <textarea name="notes" maxlength="200" rows="2" class="form-control"><?php echo $investigation_info["notes"];?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <!--/row-->
