...
GROUP BY 
  overallpros.id";
                    $overall_pros_query = mysqli_query($con, $overall_pros_query);
                    while($overall_pros_info = mysqli_fetch_assoc($overall_pros_query)) {
                        ?>
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-flex">
                                        <div>
                                            <h4 class="card-title m-b-5"><span class="lstick"></span>إحصائية لدفتر حصر التحقيق لسنة <?php echo date('Y') ?> لنيابة <?php echo $overall_pros_info['name'] ?></h4>
                                        </div>
                                    </div>
                                </div>
                                <div class="">
...
WHERE
overallpros.id = '$overall_pros_info[id]'
GROUP BY 
pros.id";
                                            ...
                                            while($pros_info = mysqli_fetch_assoc($pros_query)) {
                                                ...
                                                <tr>
                                                    <td>
                                                        <a href="pros_index.php?id=<?php echo $pros_info['id'] ?>">
                                                            <button type="button" class="btn waves-effect waves-light btn-info">
                                                                <?php echo $pros_info['name']?>
                                                            </button>
                                                        </a>
