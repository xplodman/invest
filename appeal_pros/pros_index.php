...
WHERE
  pros.id = '$_GET[id]'";
                                    ...
                                    $pros_info = mysqli_fetch_assoc($pros_query);
                                    ?>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex">
                                <div>
                                    <h3 class="card-title m-b-5"><span class="lstick"></span>إحصائية لدفتر حصر التحقيق لسنة <?php echo date('Y') ?> لنيابة <?php echo $pros_info['name'] ?> مصنفه بأسباب البقاء (أعلى 10 أسباب)</h3>
                                </div>
                            </div>
                        </div>
                        <div class="">
...
GROUP BY
  reason_to_done.name";
                                        ...
                                        $all_reason_to_done = 0;
                                        while($y = mysqli_fetch_assoc($results)) {
                                            $all_reason_to_done= $all_reason_to_done + $y['Count_reason_to_done'];
                                        }
                                        echo $all_reason_to_done
                                        ?>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex">
                                <div>
                                    <h3 class="card-title m-b-5"><span class="lstick"></span>إحصائية لدفتر حصر التحقيق لسنة <?php echo date('Y') ?> لنيابة <?php echo $pros_info['name'] ?>  مصنفه بالتهم (أعلى 10 تهم)</h3>
                                </div>
                            </div>
                        </div>
                        <div class="">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="d-flex">
                                <div>
                                    <h3 class="card-title m-b-5"><span class="lstick"></span>إحصائية لدفتر حصر التحقيق لسنة <?php echo date('Y')  ?> لنيابة <?php echo $pros_info['name'] ?>  مصنفه بأسم عضو النيابة</h3>
                                </div>
                            </div>
                        </div>
                        <div class="">
...
FROM
  ...
  INNER JOIN pros_has_users ON pros_has_users.pros_id = pros.id
WHERE
  pros.id = '$_GET[id]' AND prosecutor.status = '1'");
